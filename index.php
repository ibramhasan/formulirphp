...
<html lang="en">
  ...
  <body>
        ...
        <form method="GET" action="form.php" name="input">
            <div class="form-group">
              ...
              <select name="totaltiket" class="form-control" id="totaltiket">
                <option name="tiket1" harga="Rp. 50.000">1 ticket</option>
                <option name="tiket2" harga="Rp. 100.000">2 ticket</option>
                <option name="tiket3" harga="Rp. 150.000">3 ticket</option>
                <option name="tiket4" harga="Rp. 300.000">4 ticket</option>
              </select>
            </div>
    ...
    $("#totaltiket").on("change", function(){

    var harga = $("#totaltiket option:selected").attr("harga");
    $("#harga").val(harga);
